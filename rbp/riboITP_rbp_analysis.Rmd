...
ribo_itp_dir<- "/Users/ianhoskins/Documents/Cenik_lab/Experiments/RiboITP_RBP_analysis"
ref_dir<- "~/reference_files"
mouse_ornament_dir<- "/Users/ianhoskins/oRNAment_db"
mouse_ornament_counts_dir<- paste(mouse_ornament_dir, "oRNAment_RBP_counts_by_trx", sep="/")
mouse_oRNAment_RBP_pwms_dir<- "/Users/ianhoskins/oRNAment_db/PWMs" 
...
kozak_canonical_file<- "/Users/ianhoskins/canonical_uORF_scores/Noderer_Wang_2014_FACS_seq_TIS_efficiency.txt"
kozak_noncanonical_file<- "/Users/ianhoskins/noncanonical_uORF_scores/gkx1114_supp/nar-01911-h-2017-File009.txt"
...
```{r Look for SNPs that generate alternative start codons in the 5' UTR?}
...
Use enumerate_rbps_from_oRNAment_db.py to count RBPs, then read in the results.

```
# From oRNAment db dir, provide a specific oRNAment transcript ID list
...
with >= 1 site", 
       col="Sampled geneset", shape="Region")+
  theme_cowplot()+
