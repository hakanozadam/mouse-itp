...
human_single_cell_ribo_file = "~/projects/ribo-itp/data/human_1cell_v2.ribo"
################################################################################
########                    L I B R A R I E S                          #########
...
human_1cell_region_counts$experiment = c("1-1", "1-2")
...
human_1cell_region_total_counts_and_lengths$replicate_count = 2
