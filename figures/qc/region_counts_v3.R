...
mouse_ribo_file = "~/projects/ribo-itp/data/mouse-itp_v5.ribo"

#human_ribo_file = "../../../../itp/human-itp_v4.ribo"
human_ribo_file = "~/projects/ribo-itp/data/human-itp_v4.ribo"

#human_single_cell_ribo_file = "../../../../itp/human_1cell.ribo"
human_single_cell_ribo_file = "~/projects/ribo-itp/data/human_1cell_v3.ribo"
################################################################################
########                    L I B R A R I E S                          #########
...
plot_region_counts(human_1cell_ribo, range.lower = 29, range.upper = 35)
...
human_1cell_region_counts$experiment = c("1-1", "1-2", "1-3", "1-4", "1-5")
...
save_plot_pdf("human_region_counts_supp.pdf", human_supplementary_plot, width = 3.54, height = (1.9/8)*10 )
...
rename_1_cell_exps = function(old_name){
  if( old_name == "ITP20-150M-1C-B" ){
    return("1-4")
  } else if( old_name == "ITP20-150M-1C-C" ){
    return("1-5")
  } else if( old_name == "20230406-ITP-K562-FACS-300RNase-1cell-1" ){
    return("1-1")
  } else if( old_name == "20230406-ITP-K562-FACS-300RNase-1cell-2" ){
    return("1-2")
  } else if( old_name == "20230406-ITP-K562-FACS-300RNase-1cell-3" ){
    return("1-3")
  } else if( old_name == "1-1" ){
    return("1-1")
  } else if( old_name == "1-2" ){
    return("1-2")
  } else if( old_name == "1-3" ){
    return("1-3")
  } else if( old_name == "1-4" ){
    return("1-4")
  } else if( old_name == "1-5" ){
    return("1-5")
  }
  else{
    return("None")
...
rename_1_cell_exps = Vectorize(rename_1_cell_exps, USE.NAMES = FALSE)
...
human_1cell_region_total_counts_and_lengths$replicate_count = 5
human_1cell_region_total_counts_and_lengths$experiment = rename_1_cell_exps(human_1cell_region_total_counts_and_lengths$experiment )
...
save_plot_pdf("human_region_len_percentage_barplot_supp.pdf", human_region_len_percentage_barplot, width = 3.54, height = (1.9/8)*10 )
