...
a = wilcox.test(fourcell_TE[fourcell_TE$imprinted == 1,]$TE, fourcell_TE[fourcell_TE$imprinted == 0,]$TE)
#WAS_HERE
```
...
imprinted_supp = plot_grid(supp_first_row, supp_second_row,supp_example_gene_row, ncol = 1)



save_plot_pdf("imprinted_supp.pdf", imprinted_supp, width = 7, height = 6.9)
