...
## CPM Implementation (To be Retired)

Initially, we used CPM normalization for our comparisons. We also obtained the same results.
But we decided to use CLR normalization for consistency in the manuscript.
